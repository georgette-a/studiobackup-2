...
<h3 class=" text-st-gray text-xl pb-3">Add User</h3>
        <form action="" @submit.prevent="addClient">
          ...
          <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
            <button @click="addClient" type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-st-yellow hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Save
            </button>
          </div>
        </div>
